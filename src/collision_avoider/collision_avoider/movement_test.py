...
— completely independent of the camera, classifier, or controller.
...
Run:
    ros2 run collision_avoider movement_test
    ros2 run collision_avoider movement_test --ros-args -p linear_speed:=0.1 -p repeat:=true
